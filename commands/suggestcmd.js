...
module.exports.run = async (bot, message, args) => {
    ...
    .addField("Note", "Your suggestion is DM'd through the bot to Stentorian#9524 who will evaluate it and contact you if it is added!");
    ...
    .setFooter(`StenBot Command Suggestion from ${message.author.username}`)
