<!-- Tag line -->
<h3 align="center">Old StenBot Code</h3>

<!-- Badges -->
<p align="center">
    <a href="https://shields.io/" target="_blank">
        <img src="https://img.shields.io/github/languages/top/bwhybrow23/Old-StenBot?color=brightgreenn" alt="Main Lang"/>
    </a>
...
This repository stores the old StenBot code from before I did the recode. You can find the new code [here](https://github.com/bwhybrow23/StenBot).
